...
//        [r setPOSTDictionary:[NSDictionary dictionaryWithObjectsAndKeys:self.txtPhone.text,@"mobilephone",[order objectForKey:@"content"],@"content",[order objectForKey:@"price"],@"price",[DataService sharedService].store_id,@"store_id", nil]];
        
        [r setPOSTDictionary:@{@"mobilephone": self.txtPhone.text?:@"",@"content":[order objectForKey:@"content"]?:@"",@"price":[order objectForKey:@"price"]?:@"",@"store_id":[DataService sharedService].store_id?:@""}];
        NSLog(@"%@",r.POSTDictionary);
        [r setPostDataEncoding:NSUTF8StringEncoding];
        NSError *error = nil;
        NSDictionary *result = [[r startSynchronousWithError:&error] objectFromJSONString];
